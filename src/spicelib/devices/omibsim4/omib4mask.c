...
int
omiBSIM4mAsk(CKTcircuit* ckt, GENmodel* inst, int which, IFvalue* value)
{
  ...
  switch (which) {
    ...
    case B4_MOD_omimod:
      value->rValue = model->omimod;
      return (OK);
    case B4_MOD_agemod:
      value->rValue = model->agemod;
      return (OK);
    case B4_MOD_fvth0_age:
      value->rValue = model->fvth0_age;
      return (OK);
    case B4_MOD_dagetime:
      value->rValue = model->dagetime;
      return (OK);
    case B4_MOD_n_age:
      value->rValue = model->n_age;
      return (OK);
    case B4_MOD_Hs_age:
      value->rValue = model->Hs_age;
      return (OK);
    case B4_MOD_ms_age:
      value->rValue = model->ms_age;
      return (OK);
    case B4_MOD_Hg_age:
      value->rValue = model->Hg_age;
      return (OK);
    case B4_MOD_mg_age:
      value->rValue = model->mg_age;
      return (OK);
    case B4_MOD_Vgsdmax:
      value->rValue = model->Vgsdmax;
      return (OK);
